...
open class IntVMapC<V> : MutableMap<Int, V> {
    ...
    //private object C {
        ...
        private class ValueIterator<V>(private var sparseArrayCompat: SparseArrayCompat<V>) :
            MutableIterator<V> {
        ...
        private class KeyIterator<V>(private var sparseArrayCompat: SparseArrayCompat<V>) :
            MutableIterator<Int> {
            private var point: Int = 0
            private var mEntryValid = false
        ...
        private class MapIterator<V>(private val sparseArrayCompat: SparseArrayCompat<V>) :
